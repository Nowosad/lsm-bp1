...
Many different landscape metrics exist and they are broadly interested in three main levels of information: (i) landscape, (ii) class, and (iii) patch level.
Selected landscape level metric gives just one value describing cetrain property of a landscape mosaic, such as its diversity. 
...
This post, I show how to prepare input data and how to calculate selected landscape metrics based on a different buffer size and shape.
